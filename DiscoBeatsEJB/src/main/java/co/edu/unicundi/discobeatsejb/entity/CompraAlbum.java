...
@NamedQueries({
    ...
    @NamedQuery(name = "CompraAlbum.ObtenerComprasUsuario", query = "SELECT NEW co.edu.unicundi.discobeatsejb.dto.CompraAlbumDto" 
            + "(a.id, a.albumCompra.id, a.usuarioAlbum.id, a.albumCompra.nombre, a.usuarioAlbum.nombreUsuario, a.precioTotal, a.fechaCompra) FROM CompraAlbum a WHERE a.usuarioAlbum.id = :idusuario"),
